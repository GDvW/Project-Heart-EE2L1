...
The plot for S1 sounds and white noise in a simulation setting are given below, both for the MUSIC and MVDR algorithm.
\subsubsection{S1 sounds}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{docs/assignments/Final report/figures/figures/Localization/NEW/SimulationLocalizationPlots/Generated_S1_sounds---_bin0_z0.05_Fs48000_Q2_M6_v_sound340_d0.1_resolution0.001_modemusic_neighbourhood50.png}
    \caption{Power plot at a depth of 0.05m using the MUSIC algorithm with 2 simulated sources simulating the S1 peak.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{docs/assignments/Final report/figures/figures/Localization/NEW/SimulationLocalizationPlots/Generated_S1_sounds---_bin0_z0.12_Fs48000_Q2_M6_v_sound60.0_d0.1_resolution0.001_modemvdr_neighbourhood50.png}
    \caption{Power plot at a depth of 0.12m using the MVDR algorithm with 2 simulated sources simulating the S1 peak.}
\end{figure}



\subsubsection{White noise sources}

\begin{figure} [H]
    \centering
    \includegraphics[width=0.5\linewidth]{docs/assignments/Final report/figures/figures/Localization/NEW/Localization_results/White_Noise_Double---_bin0_z1e-07_Fs48000_Q2_M6_v_sound340_d0.1_resolution0.001_modemusic_neighbourhood3.png}
    \caption{Power plot at a depth of $10^{-7}$m using the MUSIC algorithm with 2 simulated sources simulating white noise.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{docs/assignments/Final report/figures/figures/Localization/NEW/Localization_results/White_Noise_Single---_bin0_z0.0001_Fs48000_Q1_M6_v_sound340_d0.1_resolution0.001_modemusic_neighbourhood3.png}
    \caption{Power plot at a depth of $10^{-4}$m using the MUSIC algorithm with one simulated source simulating white noise.}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{docs/assignments/Final report/figures/figures/Localization/NEW/LocalizationOwnRecording/phantom_m_silent---_bin0_z1e-05_Fs48000_Q1_M6_v_sound340_d0.1_resolution0.001_modemusic_neighbourhood3.png}
    \caption{Phantom measurement (m\_silent), $z=10^{-5}$ m, $F_s=48$ kHz, $Q=1$, $M=6$, $v=340$ m/s, $d=0.1$ m, resolution $0.001$, MUSIC.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{docs/assignments/Final report/figures/figures/Localization/NEW/LocalizationOwnRecording/phantom_m_silent---_bin0_z1e-05_Fs48000_Q1_M6_v_sound340_d0.1_resolution0.001_modemvdr_neighbourhood3.png}
    \caption{Phantom measurement (m\_silent), $z=10^{-5}$ m, $F_s=48$ kHz, $Q=1$, $M=6$, $v=340$ m/s, $d=0.1$ m, resolution $0.001$, MVDR.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{docs/assignments/Final report/figures/figures/Localization/NEW/LocalizationOwnRecording/phantom_m_t---_bin0_z1e-05_Fs48000_Q2_M6_v_sound340_d0.1_resolution0.001_modemusic_neighbourhood3.png}
    \caption{Phantom measurement (m\_t), $z=10^{-5}$ m, $F_s=48$ kHz, $Q=2$, $M=6$, $v=340$ m/s, $d=0.1$ m, resolution $0.001$, MUSIC.}
    \label{fig:phantom_m_t_music_z0p005_q2}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{docs/assignments/Final report/figures/figures/Localization/NEW/LocalizationOwnRecording/phantom_m_t---_bin0_z1e-05_Fs48000_Q2_M6_v_sound340_d0.1_resolution0.001_modemvdr_neighbourhood3.png}
    \caption{Phantom measurement (m\_t), $z=10^{-5}$ m, $F_s=48$ kHz, $Q=2$, $M=6$, $v=340$ m/s, $d=0.1$ m, resolution $0.001$, MVDR.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{docs/assignments/Final report/figures/figures/Localization/NEW/LocalizationOwnRecording/phantom_silent_t---_bin0_z0.01_Fs48000_Q1_M6_v_sound340_d0.1_resolution0.001_modemvdr_neighbourhood3.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{docs/assignments/Final report/figures/figures/Localization/NEW/LocalizationOwnRecording/phantom_silent_t---_bin0_z1e-06_Fs48000_Q1_M6_v_sound340_d0.1_resolution0.001_modemusic_neighbourhood3.png}
    \caption{Phantom measurement (silent\_t), $z=10^{-6}$ m, $F_s=48$ kHz, $Q=1$, $M=6$, $v=340$ m/s, $d=0.1$ m, resolution $0.001$, MUSIC.}
    \label{fig:phantom_silent_t_music_z0p027_q1}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{docs/assignments/Final report/figures/figures/Localization/NEW/LocalizationOwnRecording/phantom_silent_white---_bin0_z1e-05_Fs48000_Q1_M6_v_sound340_d0.1_resolution0.001_modemusic_neighbourhood3.png}
    \caption{Phantom measurement (silent\_white), $z=10^{-5}$ m, $F_s=48$ kHz, $Q=1$, $M=6$, $v=340$ m/s, $d=0.1$ m, resolution $0.001$, MUSIC.}
    \label{fig:phantom_silent_white_mvdr_z0p03_q1}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{docs/assignments/Final report/figures/figures/Localization/NEW/LocalizationOwnRecording/phantom_silent_white---_bin0_z1e-06_Fs48000_Q1_M6_v_sound340_d0.1_resolution0.001_modemvdr_neighbourhood3.png}
    \caption{Phantom measurement (silent\_white), $z=10^{-6}$ m, $F_s=48$ kHz, $Q=1$, $M=6$, $v=340$ m/s, $d=0.1$ m, resolution $0.001$, MVDR.}
    \label{fig:phantom_silent_white_music_z0p0147_q1}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{docs/assignments/Final report/figures/figures/Localization/NEW/LocalizationOwnRecording/phantom_white_silent---_bin0_z0.01_Fs48000_Q1_M6_v_sound340_d0.1_resolution0.001_modemvdr_neighbourhood3.png}
    \caption{Phantom measurement (white\_silent), $z=0.01$ m, $F_s=48$ kHz, $Q=1$, $M=6$, $v=340$ m/s, $d=0.1$ m, resolution $0.001$, MVDR.}
    \label{fig:phantom_white_silent_music_z0p01_q1}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{docs/assignments/Final report/figures/figures/Localization/NEW/LocalizationOwnRecording/phantom_white_silent---_bin0_z1e-06_Fs48000_Q1_M6_v_sound340_d0.1_resolution0.001_modemusic_neighbourhood3.png}
    \caption{Phantom measurement (white\_silent), $z=10^{-6}$ m, $F_s=48$ kHz, $Q=1$, $M=6$, $v=340$ m/s, $d=0.1$ m, resolution $0.001$, MUSIC.}
    \label{fig:phantom_white_silent_mvdr_z0p008_q1}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{docs/assignments/Final report/figures/figures/Localization/NEW/LocalizationOwnRecording/phantom_white_white---_bin0_z0.01_Fs48000_Q2_M6_v_sound340_d0.1_resolution0.001_modemvdr_neighbourhood3.png}
    \caption{Phantom measurement (white\_white), $z=0.01$ m, $F_s=48$ kHz, $Q=2$, $M=6$, $v=340$ m/s, $d=0.1$ m, resolution $0.001$, MVDR.}
    \label{fig:phantom_white_white_music_z0p007_q2}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{docs/assignments/Final report/figures/figures/Localization/NEW/LocalizationOwnRecording/phantom_white_white---_bin0_z1e-05_Fs48000_Q2_M6_v_sound340_d0.1_resolution0.001_modemusic_neighbourhood3.png}
    \caption{Phantom measurement (white\_white), $z=10^{-5}$ m, $F_s=48$ kHz, $Q=2$, $M=6$, $v=340$ m/s, $d=0.1$ m, resolution $0.001$, MUSIC.}
    \label{fig:phantom_white_white_music_z0p007_q2}
\end{figure}

\section{Module 3 recordings}
