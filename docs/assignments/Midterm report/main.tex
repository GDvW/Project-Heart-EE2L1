...
\lstdefinestyle{formattedPython}{
    language=Python,
    numbers=left,                % line numbers
    numberstyle=\small\color{gray},
    stepnumber=1,
    showstringspaces=false,      % do not mark spaces in strings
    showspaces=false,            % do not display whitespace markers
    showtabs=false,              % do not display tab markers
    frame=single,                % put a frame around code
...
Gerrald van Weelden (6320775), Ruben Jochemsen (6232531), Konstantinos Koukakis (), Arinze Ugwoke ()\\
\vspace{1cm}
TA: Jelena Pešić\\
\vspace{1cm}
