...
def generateLocalizationCommands(plot: LocalizationPlot) -> CommandProcessor:
    ...
    cp.register_symbolic_prop("z",              general_group, lambda obj: obj.z,             lambda obj, val: setattr(obj, "z", val),             dtype=float,helpmsg="The expected z-coordinate of the sound source in meters")
    ...
    cp.register_symbolic_prop("v_sound",        general_group, lambda obj: obj.v_sound,       lambda obj, val: setattr(obj, "v_sound", val),       dtype=float,helpmsg="The speed of the sound (m/s)")
    cp.register_symbolic_prop("resolution",     general_group, lambda obj: obj.resolution,    lambda obj, val: setattr(obj, "resolution", val),    dtype=float,helpmsg="The difference between the scan points in meters")
    ...
    cp.register_symbolic_prop("neighbourhood",  general_group, lambda obj: obj.neighbourhood, lambda obj, val: setattr(obj, "neighbourhood", val), dtype=int,  helpmsg="How close the peaks can be to each other")
    return cp